...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("co.edu.icesi.papupros.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("co.edu.icesi.papupros.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
